@extends('zhou::layouts.index')
@section('header')
    @include('zhou::common.header')
@stop
@section('aside')
    @include('zhou::common.aside')
@stop
@section('content')
        <!-- page header -->
                ...
                <ul>
                    <li>
                        ...
                        <a href="javascript:void(0)" title="">
                            <img src="{{asset('ZhouResources/img/start-icons/add-user.png')}}" alt="" />
                    ...
                    <li>
                        <label>246 </label>
                        <a href="javascript:void(0)" title="">
                            <img src="{{asset('ZhouResources/img/start-icons/orders.png')}}" alt="" />
                            <span>View Orders</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" title="">
                            <img src="{{asset('ZhouResources/img/start-icons/mass.png')}}" alt="" />
                            <span>Broadcast</span>
                        </a>
                    </li>
                    <li>
                        <label>new</label>
                        <a href="javascript:void(0)" title="">
                            <img src="{{asset('ZhouResources/img/start-icons/stats.png')}}" alt="" />
                    ...
                    <li>
                        <label>657</label>
                        <a href="javascript:void(0)" title="">
                            <img src="{{asset('ZhouResources/img/start-icons/pending-message.png')}}" alt="" />
                            <span>Comments</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" title="">
                            <img src="{{asset('ZhouResources/img/start-icons/upgrade.png')}}" alt="" />
                            ...
                            <div>
                                ...
                                <div class="inner-spacer chat-widget widget-content-padding">
                                        ...
                                        <div class="tab-pane fade in active" id="user1">
                                            ...
                                            <div class="chat-messages">
                                                ...
                                                <p id="message-id-1" class="message-box">
                                                    <img src="{{asset('ZhouResources/img/avatar/avatar_1.jpg')}}" alt="" />
                                                    <span class="message">
                                        ...
                                        <div class="tab-pane fade" id="user2">
                                            ...
                                            <div class="chat-messages">
                                                ...
                                                <p id="message-id-4" class="message-box">
                                                    <img src="{{asset('ZhouResources/img/avatar/avatar_2.jpg')}}" alt="" />
                                                    <span class="message">
                                    ...
                                    <div class="row-fluid chat-box">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 type-effect" style="display:none"><img src="{{asset('ZhouResources/img/loaders/misc/16-2.gif')}}" alt="" /> Victoria is typing...</div>
